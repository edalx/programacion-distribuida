...
/**
 * Created by eacuji on 06/01/17.
 */
@Configuration
@EnableJpaRepositories(basePackages = {"com.eacuji.dao"})
...
public class DataServiceConfig {
	...
	public DataSource dataSource() {
		try {
			...
			dbBuilder.generateUniqueName(true);
			return dbBuilder.setType(EmbeddedDatabaseType.DERBY).build();
		} catch (Exception e) {
	...
	public Properties hibernateProperties() {
		...
		hibernateProp.put("hibernate.dialect", "org.hibernate.dialect.DerbyDialect");
	...
	public EntityManagerFactory entityManagerFactory() {
		...
		factoryBean.setPackagesToScan("com.eacuji.entities");
